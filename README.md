Learning Objectives [# BTEC 560-Spring-2023 4 Credits, Introduction to Probability and Statistics/Fundamentals of Bioinformatics](https://pawar1550.wixsite.com/claflin-courses/copy-of-btec560).
Probability & Statistics I & II, Biostatistics, Data Analysis (topics including descriptive & inferential statistics, probability distributions, variable types (qualitative, quantitative), distribution properties, discrete & continuous types, R functions, ANOVA, T-test, correlation, chi-Square, regression, etc.). Regression (linear, multiple, logistic), Probability distributions (Discrete, Binomial, Poisson, Continuous Uniform, Chi-squared, Student-t, Fisher,)  Exponential, Normal, Chi-Square), hypothesis testing using critical value (Probability, F Statistics, Coefficient) using Analysis of Variance (ANOVA), data wrangling, Post Hoc Test. United States of America (USA). Data Visualization (BoxPlots, Scatter Plots).
...
![download](https://github.com/user-attachments/assets/78783461-0e13-4fbc-bcee-162acc8be28a)
